...
struct MemoryEditor
{
    ...
    void DrawWindow(const char* title, bool *isVisible, void* mem_data, size_t mem_size, size_t base_display_addr = 0x0000)
    {
        Sizes s;
        ...
        if (ImGui::Begin(title, isVisible, ImGuiWindowFlags_NoScrollbar))
        {
